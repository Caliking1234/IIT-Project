...
const questions = [
  {
    question:
      "1. What does PAM stand for in the context of communication systems?",
    options: [
  ...
  {
    question:
      "2. In PAM, what is the primary characteristic that varies to represent the analog signal?",
    options: [
      "Pulse Width",
      "Pulse Frequency",
      "Pulse Amplitude",
  ...
  {
    question:
      "3. In PAM, the Nyquist theorem states that the sampling rate should be at least ________ times the highest frequency component of the signal.",
    options: ["2", "4", "8", "16"],
    correctAnswer: 0,
  },
  {
    question:
      "4. Which of the following is a disadvantage of Pulse Amplitude Modulation (PAM)?",
    options: [
  ...
  {
    question:
      "5. In PAM, if you increase the number of discrete amplitude levels used to represent the analog signal, what effect does it have on signal quality?",
    options: [
    ...
    <>
      <div className="bg-gray-100 h-full p-4">
        <div className="w-full lg:px-24 mx-auto bg-white rounded-md shadow-md p-4">
          <h2 className="text-xl lg:text-4xl font-semibold my-6">
                ...
                <div key={questionIndex} className="mb-4">
                  ...
                  {question.options.map((option, optionIndex) => (
                    <div
                      ...
                      onClick={() =>
                        handleOptionSelect(optionIndex, questionIndex)
                      }
                    >
                      {option}
                    </div>
