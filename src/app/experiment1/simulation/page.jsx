      ...
      <div className=" w-full h-fit  flex items-center justify-center py-8">
        {type == 1 ? (
          <>
            ...
            <button className="absolute float-right right-[150px] top-[38vh] p-2 rounded-sm bg-red-200 ">
              {" "}
              click for modulating signal
            </button>
            <button className="absolute float-right top-[68vh] right-[170px] p-2 rounded-sm bg-green-200 ">
              {" "}
              click for modulated signal{" "}
            </button>
            <button className="absolute float-right top-[94vh] right-[270px] p-2 rounded-sm bg-orange-200 ">
              {" "}
          ...
          <>
            ...
            <button className="absolute float-left left-[150px] top-[38vh] p-2 rounded-sm bg-red-200 ">
              {" "}
              click for modulating signal
            </button>
            <button className="absolute float-left top-[68vh] left-[150px] p-2 rounded-sm bg-green-200 ">
              {" "}
              click for modulated signal{" "}
            </button>
            <button className="absolute float-right top-[55vh] right-[210px] p-2 rounded-sm bg-orange-200 ">
              {" "}
              click for carrier signal{" "}
            </button>
          </>
          ...
          <>
            ...
            <button className="absolute float-right top-[46vh] right-[210px] p-2 rounded-sm bg-orange-200 ">
              {" "}
              click for carrier signal{" "}
            </button>
          </>
