  ...
  return (
    <div className="">
      ...
      <p className="pb-6">
        ...
        digital signal has a duty cycle of 50% when it alternates between the on and off states more often than not.
      </p>

     
      <h1>Mathematical Formulation of pulse-width waveform</h1>
<p> Pulse-width modulation uses a rectangular pulse wave whose pulse width is modulated resulting in the variation of the average value of the waveform. If we consider a pulse waveform f(t), with period T, low-value ymin, a high-value ymax, and a duty cycle D, the average value of the waveform is given by</p>
