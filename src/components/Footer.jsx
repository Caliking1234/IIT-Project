...
<footer class="w-full bg-white dark:bg-gray-900">
    ...
    <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="https://flowbite.com/">IIT DELHI™</a>. All Rights Reserved. | Designed by <Link href='/' className='hover:text-green-500'>Diagnoos</Link> 
        </span>
